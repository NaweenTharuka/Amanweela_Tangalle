...
<div class="main">
	...
	<section id="travelSug">
		...
		<div class="headTitle">
			<h2>Most popular destinations in Sri Lanka</h2>
		</div>
		<div class="main_img_location_div">
			<div class="img_location">
				<img src="Travel/img/travel_pg/hikkaduwa.jpg">
				<div class="details">
					<h2 >Hikkaduwa</h2>
					<a href="#f1"><h4 id="Hikkaduwa" onclick="funcDestination('Hikkaduwa')">Pick</h4></a>
				</div>
			</div>
			<div class="img_location">
				<img src="Travel/img/travel_pg/kithulgala.jpg">
				<div class="details">
					<h2 >Kithulgala</h2>
					<a href="#f1"><h4 onclick="funcDestination('Kithulgala')">Pick</h4></a>
				</div>
			</div>
			<div class="img_location">
				<img src="Travel/img/travel_pg/udawalawa.jpg">
				<div class="details">
					<h2 >Udawalawa</h2>
					<a href="#f1"><h4 onclick="funcDestination('Udawalawa')">Pick</h4></a>
				</div>
			</div>
			<div class="img_location">
				<img src="Travel/img/travel_pg/sigiriya.jpg">
				<div class="details">
					<h2 >Sigiriya</h2>
					<a href="#f1"><h4 onclick="funcDestination('Sigiriya')">Pick</h4></a>
				</div>
			</div>
		</div>
	</section>
	...
	<div class="travel_main_2" id="recentRideTable" >
		<div>
			<h3 style="color:#fff !important;">Recent Ride</h3>
		</div>
